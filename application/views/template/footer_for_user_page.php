...
<!--   Core JS Files   -->
<script src="<?php echo base_url('assets/assets/js/core/popper.min.js')?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/assets/js/core/bootstrap.min.js')?>" type="text/javascript"></script>
...
<script src="<?php echo base_url('assets/assets/js/plugins/countup.min.js')?>"></script>
...
<script src="<?php echo base_url('assets/assets/js/plugins/choices.min.js')?>"></script>
...
<script src="<?php echo base_url('assets/assets/js/plugins/prism.min.js')?>"></script>
<script src="<?php echo base_url('assets/assets/js/plugins/highlight.min.js')?>"></script>
...
<script src="<?php echo base_url('assets/assets/js/plugins/rellax.min.js')?>"></script>

<!-- <script src="./assets/js/plugins/rellax.min.js"></script> -->
<!--  Plugin for TiltJS, full documentation here: https://gijsroge.github.io/tilt.js/ -->
<script src="<?php echo base_url('assets/assets/js/plugins/tilt.min.js')?>"></script>
...
<script src="<?php echo base_url('assets/assets/js/soft-design-system.min.js?v=1.0.9')?>" type="text/javascript"></script>
